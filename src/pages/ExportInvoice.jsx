    ...
    <div className="ei">
      ...
      <div className="ei-toolbar">
        ...
        <span className="ei-title">
          Export Service Invoice · build v6
        </span>
      ...
      <div className="ei-app">
        ...
        <div className="ei-form">
          ...
          <div className="ei-hint">
            Prints as {f.prefix}/&lt;serial&gt;/2026-27.
            Switching series keeps the same serial — it doesn't reset.
          </div>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div className="desc-fixed">
                      International export of services as per
