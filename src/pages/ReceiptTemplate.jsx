  ...
  return (
    <div
      ...
      style={{
        ...
        padding: 0,
        margin: 0,
        display: "flex",          // column layout so the bank/signature block
        flexDirection: "column",  // can be pushed to the bottom by a spacer
      }}
    >
      {/* Header */}
                ...
                return (
                  <tr key={index}>
                    ...
                    <td style={{ border: "1px solid #2b2b2b", padding: "6px 6px", whiteSpace: "pre-wrap", wordBreak: "break-word", textAlign: "left" }}>
                      {isAdvance ? (
                        <div style={{ fontWeight: 700 }}>Advance Received</div>
                      ) : (
                        item.description
                      )}
                    </td>
      ...
      {/* Spacer — pushes the bank/signature block below to the bottom of the
          page, no matter how many line items there are. */}
